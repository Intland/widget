...
@Component
@Qualifier("recentlyChangedTrackerItemsWidgetEditorRenderer")
public class RecentlyChangedTrackerItemsWidgetEditorRenderer extends DefaultWidgetEditorRenderer<RecentlyChangedTrackerItemsWidget> {

	@Autowired
	public RecentlyChangedTrackerItemsWidgetEditorRenderer(final ModelPopulator<VelocityContext> modelPopulator,
	...
	protected Map<String, WidgetAttribute> getDescriptor() {
		return RecentlyChangedTrackerItemsWidget.getDescriptor();
	}
