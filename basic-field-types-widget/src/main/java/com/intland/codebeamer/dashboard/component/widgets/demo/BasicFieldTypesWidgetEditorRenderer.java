...
public class BasicFieldTypesWidgetEditorRenderer extends DefaultWidgetEditorRenderer<BasicFieldTypesWidget> {

	@Autowired
	public BasicFieldTypesWidgetEditorRenderer(final ModelPopulator<VelocityContext> modelPopulator,
